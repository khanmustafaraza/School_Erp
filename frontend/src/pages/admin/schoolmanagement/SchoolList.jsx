          ...
          <tbody className="">
            {state?.schoolList?.map((s, index) => (
              <tr key={s._id} className="bg-gray-100 hover:bg-gray-300">
                ...
                <td className="px-4 py-1 text-gray-800">{s?.subName || "-"}</td>
                <td className="px-4 py-1 text-gray-800">{s?.code || "-"}</td>
                <td className="px-4 py-1 text-gray-800">
                  {s?.affiCode || "-"}
                </td>
                <td className="px-4 py-1 text-gray-800">{s?.email || "-"}</td>
                <td className="px-4 py-1 text-gray-800">{s?.contact || "-"}</td>
                <td className="px-4 py-1 text-gray-800">{s?.address || "-"}</td>
